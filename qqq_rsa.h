...
// RSA512 encrypt raw
// plain text msg_enc[64] to encrypted msg_enc[64], using modulus[64]. modulus[64] is unchanged
...
// encrypt plain text msg[msglen] and random bytes rnd_enc[64] to encrypted rnd_enc[64], using modulus[64]. modulus[64] and msg[msglen] are unchanged
// NOTE: maximum msglen is 53
